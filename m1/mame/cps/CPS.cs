...
namespace mame
{
    public partial class CPS
    {
        ...
        public static void CPSInit()
        {
            ...
            Machine.bRom = true;
            Memory.mainrom = new byte[0x10000];//Machine.GetRom("maincpu.rom");
            gfxrom = new byte[0x10000];//Machine.GetRom("gfx.rom");
            n = gfxrom.Length;
            ...
            switch (Machine.sBoard)
            {
                case "CPS-1":
                    cps_version = 1;
                    starsrom = new byte[0x10000];// Machine.GetRom("stars.rom");
                ...
                case "CPS2":
                    ...
                    {
                        mainromop = new byte[0x10000];// Machine.GetRom("maincpuop.rom");
                    }
        ...
        public static void play_cps_megaman(TrackInfo ti)
        {
            ...
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, 0x00));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 1, 0xff));
        }
        public static void stop_cps_megaman(TrackInfo ti)
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, 0x00));
        ...
        public static void stopandplay_cps_megaman(TrackInfo ti)
        {
            ...
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 2, 1, 0x00));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 3, 0, 0x00));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 3, 1, 0xff));
        }
        public static void play_cps_dinohunt(TrackInfo ti)
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, (byte)ti.TrackID));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 1, 0x00));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 1, 0x33));
        }
        public static void stopandplay_cps_dinohunt(TrackInfo ti)
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, (byte)RomInfo.IStop));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, (byte)ti.TrackID));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 1, 0x00));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 2, 1, 0x33));
        }
        public static void stop_cps_strider(TrackInfo ti)
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, (byte)ti.TrackID));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, 0xf7));
        }
        ...
        public static void play_qsound_default(TrackInfo ti)
        {
            ...
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0x0f, 0x00));
        }
        ...
        public static void stopandplay_qsound_default(TrackInfo ti)
        {
            ...
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0x0f, 0x00));
        }
