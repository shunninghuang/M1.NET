...
namespace mame
{
    public partial class Namcos1
    {
        ...
        public static void Namcos1Init()
        {
            ...
            gfx3rom = new byte[0x10000];// ByteTo2byte(Machine.GetRom("gfx3.rom"));
            user1rom = new byte[0x400000];// Machine.GetRom("user1.rom");
        ...
        public static void play_namcos1_default(TrackInfo ti)
        {
            if (ti.TrackID >= 0x100)
            {
                Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0x140 + ti.TrackID, 0x01));
            }
            else
            {
                Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0x1100, (byte)ti.TrackID));
                Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0x1101, 0x40));
            }
        }
        ...
        public static void stopandplay_namcos1_default(TrackInfo ti)
        {
            ...
            else
            {
                ...
                Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0x1101, 0x40));
            }
        }
    }
}
