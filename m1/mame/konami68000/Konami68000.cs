...
namespace mame
{
    public partial class Konami68000
    {
        ...
        public static void Konami68000Init()
        {
            ...
            {
                case "cuebrick":
                    K052109_memory_region = new byte[0x10000];// Machine.GetRom("k052109.rom");
                    K051960_memory_region = new byte[0x10000];//Machine.GetRom("k051960.rom");
                ...
                case "ssridersjbd":
                    K052109_memory_region = new byte[0x10000];//Machine.GetRom("k052109.rom");
                    K053245_memory_region[0] = new byte[0x10000];//Machine.GetRom("k053245.rom");
                    K053260.k053260rom = Machine.GetRom("k053260.rom");
                ...
                case "glfgreatj":
                    K052109_memory_region = new byte[0x10000];//Machine.GetRom("k052109.rom");
                    K053245_memory_region[0] = new byte[0x10000];//Machine.GetRom("k053245.rom");
                    zoomrom = new byte[0x10000];//Machine.GetRom("zoom.rom");
                    user1rom = new byte[0x10000];//Machine.GetRom("user1.rom");
                    K053260.k053260rom = Machine.GetRom("k053260.rom");
