        ...
        public static void TaitoInit()
        {
            ...
            switch (Machine.sName)
            {
                ...
                case "tokiob":
                    ...
                    slaverom = new byte[0x10000]; //Machine.GetRom("slave.rom");
                    Memory.audiorom = Machine.GetRom("audiocpu.rom");
                    gfx12rom = new byte[0x10000]; //Machine.GetRom("gfx1.rom");
                    n = gfx12rom.Length;
                ...
                case "opwolfu":
                    ...
                    Memory.audioram = new byte[0x1000];
                    Memory.mainrom = new byte[0x400000]; //Machine.GetRom("maincpu.rom");
                    ...
                    gfx22rom = new byte[0x10000]; //Machine.GetRom("gfx2.rom");
                    n = gfx22rom.Length;
