...
namespace mame
{
    public partial class Sound
    {
        ...
        public delegate void track_delegate(TrackInfo ti);
        public static track_delegate playtrack, stoptrack;
        public static track_delegate stopandplaytrack;
        public delegate void sound_delegate(ushort i);
        public static sound_delegate PlayDelegate, StopDelegate;
        public delegate void sound_deletete2(ushort i1, ushort i2);
        public static sound_deletete2 StopAndPlayDelegate;
        public static void sound_init()
        {
            ...
            switch (Machine.sBoard)
            {
                ...
                case "CPS-1(QSound)":
                    ...
                    Inptport.lsFA.Add(new FrameArray(0, 0xffd, 0x88));
                    Inptport.lsFA.Add(new FrameArray(0, 0xfff, 0xff));
                    break;
                case "CPS2":
                case "CPS2turbo":
                    sound_update = sound_update_qsound;
                ...
                case "Technos":
                    switch (Machine.sName)
                    {
                        ...
                        case "darktowr":
                            ...
                            playtrack = Technos.play_technos_default;
                            stoptrack = Technos.stop_technos_default;
                            stopandplaytrack = Technos.stopandplay_technos_default;
                            break;
                        case "ddragon2":
                        case "ddragon2u":
                        case "ddragon2b":
                ...
                case "Megasys1":
                    switch (Machine.sName)
                    {
                        ...
                        case "jitsupro":
                            ...
                            OKI6295.oo1[1].OKI.stream = new sound_stream(4000000 / 132, 0, 1, OKI6295.oo1[1].okim6295_update);
                            mixerstream = new sound_stream(48000, 4, 0, null);
                            playtrack = Megasys1.play_megasys1_jitsupro;
                            stoptrack = Megasys1.stop_megasys1_jitsupro;
                            stopandplaytrack = Megasys1.stopandplay_megasys1_jitsupro;
                            break;
                        case "hayaosi1":
                            latched_value = new ushort[2];
                            utempdata = new ushort[2];
                ...
                case "Gaelco":
                    switch (Machine.sName)
                    {
                        case "bigkarnk":
                            ...
                            stoptrack = M72.stop_m72_default;
                            stopandplaytrack = M72.stopandplay_m72_default;
                            Inptport.lsFA.Add(new FrameArray(0, 0, 0));
                            break;
                        case "biomtoy":
                        case "biomtoya":
                        case "biomtoyb":
                ...
                case "Namco System 1":
                    ...
                    Inptport.lsFA.Add(new FrameArray(0, 0, 0xa6));
                    break;
                case "M72":
                    latched_value = new ushort[1];
                    utempdata = new ushort[1];
                ...
                case "Taito":
                    switch (Machine.sName)
                    {
                        ...
                        case "tokiob":
                            ...
                            Inptport.lsFA.Add(new FrameArray(0, 0, 0xef));
                            break;
                        case "bublbobl":
                        case "bublbobl1":
                        case "bublboblr":
		...
		public static void sound_update_technos_ddragon()
        {
            ...
            for (sampindex = 0; sampindex < 0x3c0; sampindex++)
            {
                ...
                finalmixb[sampindex * 4 + 2] = (byte)samp;
                finalmixb[sampindex * 4 + 3] = (byte)((samp & 0xff00) >> 8);
                if (bSound == false && sampmax - sampmin > 2)
                {
                    bSound = true;
                    nZero = 0;
                }
        ...
        {
            bool bSound = false;
            int sampindex, sampminL = 32767, sampminR = 32767, sampmaxL = -32768, sampmaxR = -32768;
            ym2151stream.stream_update();
            OKI6295.oo1[0].OKI.stream.stream_update();
            ...
            for (sampindex = 0; sampindex < 0x3c0; sampindex++)
            {
                ...
                finalmixb[sampindex * 4 + 2] = (byte)sampR;
                finalmixb[sampindex * 4 + 3] = (byte)((sampR & 0xff00) >> 8);
                if (bSound == false && sampmaxL - sampminL > 10 && sampmaxR - sampminR > 10)
                {
                    bSound = true;
                    nZero = 0;
                }
