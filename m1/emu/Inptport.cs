...
namespace mame
{
    ...
    {        
        ...
        public static void input_port_init()
        {
            ...
            switch (Machine.sBoard)
            {
                ...
                case "Neo Geo":
                    ...
                    break;
                case "Technos":
                    loop_inputports_callback = loop_inputports_technos;
                    break;
                case "Tad":
                ...
                case "Megasys1":
                    switch (Machine.sName)
                    {
                        case "lomakai":
                        case "makaiden":
                            loop_inputports_callback = loop_inputports_megasys1_z;
                            break;
                        case "p47":
                        case "p47j":
                        case "p47je":
                        ...
                        case "edfu":
                        //case "edfbl":
                            loop_inputports_callback = loop_inputports_megasys1_a;
                            break;
                        case "jitsupro":
                            loop_inputports_callback = loop_inputports_megasys1_a2;
                            break;
                        case "64street":
                        case "64streetj":
                        case "64streetja":
                        ...
                        case "chimerab":
                        case "cybattlr":
                            loop_inputports_callback = loop_inputports_megasys1_c;
                            break;
                        case "hayaosi1":
                            loop_inputports_callback = loop_inputports_megasys1_a;
                            break;
                ...
                case "Gaelco":
                    ...
                    {
                        case "bigkarnk":
                            loop_inputports_callback = loop_inputports_gaelco_bigkarnk;
                            break;
                        case "biomtoy":
                        case "biomtoya":
                        case "biomtoyb":
            ...
            switch (Machine.sName)
            {
                ...
                case "opwolfu":
                case "opwolfb":
                    loop_inputports_callback = loop_inputports_taito_opwolf;
                    break;
                case "pbobble":
                case "sbm":
        ...
        public static void frame_update_callback()
        {
            ...
            {
                Taitosnd.taitosound_port_w(0, 4);
                Taitosnd.taitosound_comm_w(0, 1);
            }
            else if (Video.screenstate.frame_number == 0x10)
            {
                Taitosnd.taitosound_port_w(0, 4);
                Taitosnd.taitosound_comm_w(0, 0);
            }*/
        ...
        public static void loop_inputports_technos()
        {
            int i;
            for (i = lsFA.Count - 1; i >= 0; i--)
            {
                if (Video.screenstate.frame_number == lsFA[i].frame_number_obj)
                {
                    Technos.ddragon_interrupt_w(3, lsFA[i].id);
                    lsFA.Remove(lsFA[i]);
                }
            }
        }
        public static void loop_inputports_megasys1_z()
        {
            int i;
            for (i = lsFA.Count - 1; i >= 0; i--)
            {
                if (Video.screenstate.frame_number == lsFA[i].frame_number_obj)
                {
                    Megasys1.soundlatch_z_w2(lsFA[i].id);
                    lsFA.Remove(lsFA[i]);
                }
            }
        }
        public static void loop_inputports_megasys1_a()
        {
            int i;
            for (i = lsFA.Count - 1; i >= 0; i--)
            {
                if (Video.screenstate.frame_number == lsFA[i].frame_number_obj)
                {
                    Megasys1.megasys1_soundlatch_w2(lsFA[i].id);
                    lsFA.Remove(lsFA[i]);
                }
            }
        }
        public static void loop_inputports_megasys1_a2()
        {
            int i;
            for (i = lsFA.Count - 1; i >= 0; i--)
            {
                if (Video.screenstate.frame_number == lsFA[i].frame_number_obj)
                {
                    Megasys1.megasys1_soundlatch_w((ushort)(lsFA[i].id * 0x100));
                    lsFA.Remove(lsFA[i]);
                }
            }
        }
        public static void loop_inputports_megasys1_c()
        {
            int i;
            for (i = lsFA.Count - 1; i >= 0; i--)
            {
                if (Video.screenstate.frame_number == lsFA[i].frame_number_obj)
                {
                    Megasys1.soundlatch_c_w2(lsFA[i].id);
                    lsFA.Remove(lsFA[i]);
                }
            }
        }
        public static void loop_inputports_gaelco_bigkarnk()
        {
            int i;
            for (i = lsFA.Count - 1; i >= 0; i--)
            {
                if (Video.screenstate.frame_number == lsFA[i].frame_number_obj)
                {
                    Gaelco.bigkarnk_sound_command_w(lsFA[i].id);
                    lsFA.Remove(lsFA[i]);
                }
            }
        }
        ...
        public static void loop_inputports_taito_opwolf()
        {
            ...
            for (i = lsFA.Count - 1; i >= 0; i--)
            {
                if (Video.screenstate.frame_number == lsFA[i].frame_number_obj)
                {
                    ...
                    Taitosnd.taitosound_comm_w(0, (byte)(lsFA[i].id & 0xf));
